...
describe('Service Tests', () => {
  describe('Abonos routing resolve service', () => {
    ...
    let routingResolveService: AbonosRoutingResolveService;
    let service: AbonosService;
    let resultAbonos: IAbonos | undefined;
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(AbonosRoutingResolveService);
    ...
    describe('resolve', () => {
      ...
      it('should return new IAbonos if id is not provided', () => {
        // GIVEN
        ...
        expect(resultAbonos).toEqual(new Abonos());
      });

      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Abonos })));
        mockActivatedRouteSnapshot.params = { id: 123 };
