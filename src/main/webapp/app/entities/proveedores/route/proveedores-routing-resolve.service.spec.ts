...
describe('Service Tests', () => {
  describe('Proveedores routing resolve service', () => {
    ...
    let resultProveedores: IProveedores | undefined;
    ...
    describe('resolve', () => {
      ...
      it('should return new IProveedores if id is not provided', () => {
        // GIVEN
        ...
        expect(resultProveedores).toEqual(new Proveedores());
      });

      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Proveedores })));
        mockActivatedRouteSnapshot.params = { id: 123 };
